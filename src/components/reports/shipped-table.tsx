  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        {(q || factory || buyer || pay) && (
          <button onClick={() => { setQ(""); setFactory(""); setBuyer(""); setPay(""); }} className="rounded-sm border border-line px-2.5 py-1.5 text-xs text-ink-soft hover:border-accent hover:text-accent">Clear</button>
        )}
